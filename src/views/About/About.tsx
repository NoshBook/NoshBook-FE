    ...
    >
      ...
      <section className={styles.twoByTwo}>
        ...
        <div className={`${styles.flexCol} ${styles.card}`}>
          ...
          Zack Lyon is a software developer with sixteen years of experience
          working in the high tech field of microprocessor lithography. His
          favorite food is sushi, unless we&apos;re counting coffee.
        </div>
      </section>
    </motion.main>
  );
